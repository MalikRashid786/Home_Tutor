...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 30, 2023 at 11:52 AM
...
--
CREATE DATABASE IF NOT EXISTS `onlinelawyer` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `onlinelawyer`;
...
CREATE TABLE `tbl_inlawtype` (
  `lawtype_id` int(11) NOT NULL,
...
(11, 'Rashid', 'ra@gmail.com', '5adef4cc9e317ec7d0b35eee1d44fd98', '7458847451', 'DR4587', '--', '0', '--', '--', '--', '--', '0000-00-00', 'www.example.com', '--', '--', '--', '--', '--', '--', '--', 'avatar.svg', 0, '2022-03-17 22:38:57'),
...
(12, 'Rashid', 'r8s@gmail.com', '89402387bbfcbcd825a3c1a112b2d282', '786012345', '7458DR', '--', '0', '--', '--', '--', '--', '0000-00-00', 'www.example.com', '--', '--', '--', '--', '--', '--', '--', 'avatar.svg', 0, '2022-03-17 22:40:21'),
(13, 'ra', 'ra45@gmail.com', '25d55ad283aa400af464c76d713c07ad', '12345678', 'DR45212AS', '--', '0', '--', '--', '--', '--', '0000-00-00', 'www.example.com', '--', '--', '--', '--', '--', '--', '--', 'avatar.svg', 0, '2023-04-30 01:38:31');
...
CREATE TABLE `tbl_lawyer_lawtype` (
  `law_type_id` int(11) NOT NULL,
  `name` varchar(200) NOT NULL,
  `lawyer_id` int(11) NOT NULL,
  `date_time` datetime NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
CREATE TABLE `tbl_lawyer_payment` (
...
(12, 'ra@gmail.com', '2023-04-30', '01:05:11');
...
CREATE TABLE `tbl_practicingcourt` (
  `practicingcourt_id` int(11) NOT NULL,
...
(19, 'Noor', 'noor@gmail.com', '7458847451', 'e10adc3949ba59abbe56e057f20f883e', '--', '36', '23', 'Beta 1, Greater Noida', '201310', '2023-04-30', '01:36:03');
...
--
-- Indexes for table `tbl_answere`
--
ALTER TABLE `tbl_answere`
...
--
-- Indexes for table `tbl_inlawtype`
--
ALTER TABLE `tbl_inlawtype`
  ADD PRIMARY KEY (`lawtype_id`);
...
--
-- Indexes for table `tbl_lawyer_lawtype`
--
ALTER TABLE `tbl_lawyer_lawtype`
  ADD PRIMARY KEY (`law_type_id`);

--
-- Indexes for table `tbl_lawyer_payment`
--
ALTER TABLE `tbl_lawyer_payment`
...
--
-- Indexes for table `tbl_practicingcourt`
--
ALTER TABLE `tbl_practicingcourt`
  ADD PRIMARY KEY (`practicingcourt_id`);
...
--
-- Indexes for table `tbl_star`
--
ALTER TABLE `tbl_star`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_answere`
--
ALTER TABLE `tbl_answere`
  MODIFY `answered_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `tbl_district`
  MODIFY `district_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
...
--
-- AUTO_INCREMENT for table `tbl_inlawtype`
--
ALTER TABLE `tbl_inlawtype`
  MODIFY `lawtype_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `tbl_language`
--
ALTER TABLE `tbl_language`
  MODIFY `lan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
-- AUTO_INCREMENT for table `tbl_lawyer_lawtype`
--
ALTER TABLE `tbl_lawyer_lawtype`
  MODIFY `law_type_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;

--
-- AUTO_INCREMENT for table `tbl_lawyer_payment`
--
ALTER TABLE `tbl_lawyer_payment`
...
--
-- AUTO_INCREMENT for table `tbl_practicingcourt`
--
ALTER TABLE `tbl_practicingcourt`
  MODIFY `practicingcourt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
...
--
-- AUTO_INCREMENT for table `tbl_star`
--
ALTER TABLE `tbl_star`
