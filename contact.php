...
<section class="bg-secondary">
  <div class="container text-dark border-0 contactform">
    <div class="row justify-content-center">
      <div class="col-md-5 col-xl-5 col-sm-11">
        <h1 class="ml-2 mt-4 text-green">Connect with Us  </h1>
      ...
      <div class="col-lg-5 col-md-6 mb-5 mt-4 text-dark">
...
<section class="OurLocation bg-secondary">
  <div class="container text-dark">
    <div class="row text-center">
      ...
      <div class="col-sm-4 mb-4" data-aos="fade-right">
        <div class="card shadow border-0">
          <div class="web-info">
...
<section class="map bg-secondary">
  <div class="container">
