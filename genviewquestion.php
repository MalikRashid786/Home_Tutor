...
$query7 = "SELECT count(answered_id) AS `totalanswere` FROM tbl_answere";
...
?>
<section id="question" class="bg-secondary">
  <div class="container mt-5" id="allanswere">
    <div class="py-3 bg-white shadow card">
      <div class="row">
        <div class="col-md-6 col-8 ">
          <h1 class="ml-3 text-dark">Question/Answere</h1>
        </div>
        <div class="col-md-6 col-4">
          <a href="genaskquestion.php"><button class="btn btn-success  btn-sm mt-2  mr-2 float-right mr-1">Ask a question</button>
          </a>
        </div>
      </div>
    </div>
        ...
        ?>
          <div class="card bg-transparent mt-2 border-0">
            ...
            <div class="col-xl-5 col-md-7">
              <div class="card card-stats mb-3 border-0 shadow">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h4 class="card-title text-uppercase mb-0"><?php echo $lawyer_name ?></h4>
                      <span class="h5 font-weight-bold mb-0">Teacher,</span>
                      <small> <?php echo $practicingstate ?></small><br />
                      <small><span style="font-size: 11px"><?php echo LawyerGetRating($lawyerid); ?> </span></small>
                      <p class="mt-1 mb-0 text-muted carddown text-sm">
                        <a style="font-size: 12px" href="genlawyerprofile.php?la_id=<?php echo $lawyerid; ?>" class="text-success ml-1"> View <i class="fa fa-arrow-right" style="font-size: 9px"></i></a>
                      </p>
                    </div>
