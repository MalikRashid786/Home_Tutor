      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-12 col-md-12 mt-5">
            <h1 class="display-2 text-white">Find Best Teachers in India</h1>
...
<section id="toplawyer" class="bg-secondary py-5">
          ...
          <div class="col-md-3 col-6 col-lg-3 mb-5">
              <div class="card border-0 shadow">
                ...
                <div class="card-body mt-5">
                   ...
                   <div class="row justify-content-center">
                    <span class="text-success text-sm h5"><a href="userlawyerprofile?la_id=<?php echo$row4['lawyer_id'];?>" style="font-size: 12px" class="text-success">View <i class="fa fa-arrow-right" style="font-size: 9px"></i></a></span>
                   </div>
                  </div>
