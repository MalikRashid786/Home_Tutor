    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-xl-12 col-md-12">
          <h1 class="display-2 text-white">Find Best Teacher in Your City</h1>
...
<section id="toplawyer" class="bg-secondary">
  <div class="container" style="margin-top: -180px">
    <div class="row">
      ...
      <div class="row justify-content-center">
        <a href="lawyerviewalllawyer.php"><button class="btn bg-gradient-success text-white viewlawyer  mt-3">View more Lawyer</button></a>
      </div> -->
  </div>
</section>
<?php
